...
int main () {
    ...
    double xmin = 0.0, xmax = 0.1001, xspacing = 0.005;
    double ymin = 0.0, ymax = 0.1001, yspacing = 0.005;
    ...
    std::ofstream  fnode, fcons, felem;
...
//%%%%%%%%%%%% BEGIN VELOCITY CONSTRAINT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    int totalCons = (2*xnumNodes) + (2*(ynumNodes-2));
